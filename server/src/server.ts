/*
 * ============================================================================
 * SCREENSHOTSTUDIO - BACKEND (COMMENTED OUT - DO NOT DELETE)
 * ============================================================================
 *
 * The app has been converted to a fully static, free portfolio project: the
 * 3D editor and image export run entirely in the browser. This server used to
 * handle Google OAuth login, Stripe billing, and Postgres user/export tracking,
 * none of which are needed anymore.
 *
 * Everything below is preserved (commented out line-by-line) so it can be
 * restored if auth/payments are ever reintroduced. To restore: remove the
 * leading "//" from each line and re-run `tsc` in this directory.
 */
//
