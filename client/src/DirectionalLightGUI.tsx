    ...
    return (
        <>
        {
            <div style={{
                ...
                className="absolute rounded-xl right-[800px] top-[200px] min-w-[300px] min-h-[150px] max-w-[450px] overflow-auto bg-chocolate overflow-auto  pb-3 z-50 backdrop-blur-md border border-stone-600 shadow-lg ring-1 ring-stone-700/50">
