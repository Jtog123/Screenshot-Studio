        ...
        <>  
            {
                (
                    isToolbarToggled ? 
                        <div className="fixed h-screen bg-stone-950 text-stone-300 z-19 right-0 w-[5%] transition-all duration-300 ease-in-out ">
                        ...
                        :
                        <div className="fixed flex flex-col flex-1 min-h-0  w-[20%] h-[100%] bg-stone-950 z-19 right-0 transition-all duration-300 ease-in-out z-19  ">
                            <ToolbarHeader isToolbarToggled={isToolbarToggled} setToolbarToggled={handleToggle}/>
                            <div className='flex flex-col flex-1 overflow-y-auto overflow-x-hidden '>
