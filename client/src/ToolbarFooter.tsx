...
export default function ToolbarFooter({isToolbarToggled, setToolbarToggled}: ToolbarFooterProps) {
    return(
        <>
            <div className={isToolbarToggled ? `flex w-full items-center justify-center  h-[7%] bg-cream-golden py-2 bottom-0` : `flex w-full items-center justify-between h-[7%] bg-cream-golden`}>
