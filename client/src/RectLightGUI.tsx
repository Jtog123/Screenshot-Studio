                        ...
                        {expandedSections.appearance && (
                            <div className="p-3 space-y-3 bg-chocolate">
                                <div className="grid grid-cols-1 gap-3">
                                    ...
                                    <div>
                                        <label className="text-xs text-cream-vanilla" style={{ fontFamily: 'lato' }}  htmlFor="">Width:</label>
                                        <input onChange={(e) => handleLightWidthChange(e)} className="h-1 w-full accent-[#7D5328]" type="range" min={"1"} max={"3.5"} value={lightWidth} step={"0.1"}/>
                                    </div>

                                    <div>
                                        <label className="text-xs text-cream-vanilla" style={{ fontFamily: 'lato' }}  htmlFor="">Height:</label>
                                        <input onChange={(e) => handleLightHeightChange(e)} className="h-1 w-full accent-[#7D5328]" type="range" min={"1"} max={"3.5"} value={lightHeight} step={"0.1"}/>
                                    </div>

                                    <div>
                                        <label className="text-xs text-cream-vanilla" style={{ fontFamily: 'lato' }}  htmlFor="">Intensity:</label>
                                        <input onChange={(e) => handleLightIntensityChange(e)} className="h-1 w-full accent-[#7D5328]" type="range" min={"1"} max={"10"} value={lightIntensity} step={"0.1"}/>
                                    </div>
