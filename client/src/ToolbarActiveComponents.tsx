...
export default function ToolbarActiveComponents({activeListItems, setActiveListItems, isToolbarToggled, lightManager, assetManager} : ToolbarLightCatalogProps) {
    ...
    return (
        <>
            ...
            <div className="flex-1 w-[80%]  bg-cream-vanilla overflow-y-auto overflow-x-hidden px-3 py-2 scrollbar-thin scrollbar-thumb-stone-700 scrollbar-track-stone-900 ">
                {activeListItems.length === 0 ? (
                    <div className="flex items-center justify-center h-full ">
                        <p className="text-espresso/50 text-sm" style={{ fontFamily: 'lato' }}>No items in scene</p>
                    </div>
                ) : (
