    ...
    return(
        <>
            <div className="fixed flex h-[7%] w-[100%]  z-21">
                ...
                <div className="LogoTitleContainer flex w-[33%] h-[100%] items-center  bg-blue-powder/60">
                    {/*img here */}
                    <div className="h-[90%]">
                ...
                <div className="navigationLinks flex justify-center  w-[77%] h-[100%]  bg-blue-powder/60">
