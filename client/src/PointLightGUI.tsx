                        ...
                        {expandedSections.appearance && (
                            <div className="p-3 space-y-3 bg-chocolate">
                                <div className="grid grid-cols-1 gap-3">
                                    ...
                                    <div>
                                        <label className="text-xs text-cream-vanilla" style={{ fontFamily: 'lato' }}  htmlFor="">Distance:</label>
                                        <input onChange={(e) => handleLightDistanceChange(e)} className="h-1 w-full accent-[#7D5328]" type="range" min={"1"} max={"50"} value={lightDistance} step={"1"}/>
                                    </div>
