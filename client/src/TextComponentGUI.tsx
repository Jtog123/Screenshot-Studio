...
interface TextComponentGUIProps {
    _componentID : string;
    textData : TextComponentInterface | undefined
    onClose : (id: string) => void

}

export default function TextComponentGUI({_componentID, textData} : TextComponentGUIProps) {
    ...
    const[guiPosition, setGuiPosition] = useState({x: _guiX, y: _guiY});
